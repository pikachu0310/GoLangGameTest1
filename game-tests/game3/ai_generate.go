...
import (
	"fmt"
	"github.com/pikachu0310/GoLangGameTest1.git/game-tests/game3/api"
	"regexp"
	"strconv"
	"strings"
)
...
func GptGenerateItem() (*Item, error) {
	res, err := Gpt(MakeItemMessage, func(s string) {})
	if err != nil {
		return &Item{}, err
	}
